...
The explicit `leaps_swing` profile uses a separate `option_leaps_swing` evidence lane. Its 5-, 10-, and 20-session cohorts must each pass independently with 100% broker-market-observed outcomes; ordinary option evidence and DTE alone cannot authorize LEAPS review.

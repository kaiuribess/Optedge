...
- Describes the architecture and factor library.
- Defines validation, sizing, risk, and limitation methodology.
- Documents data-source reliability and approval-gated Robinhood workflows.

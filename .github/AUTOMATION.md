...
- `workflows/ci.yml` tests the installed application on Python 3.11 through 3.13, runs the focused lint gate, and repeats the public installer plus offline-demo flow on Windows.
